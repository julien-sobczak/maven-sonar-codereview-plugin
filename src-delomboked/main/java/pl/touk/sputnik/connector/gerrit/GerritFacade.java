...
public class GerritFacade implements ConnectorFacade {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(GerritFacade.class);
    ...
    public List<ReviewFile> listFiles() {
        try {
            ...
            Map<String, FileInfo> changeFiles = gerritApi.changes().id(gerritPatchset.getChangeId()).revision(gerritPatchset.getRevisionId()).files();
