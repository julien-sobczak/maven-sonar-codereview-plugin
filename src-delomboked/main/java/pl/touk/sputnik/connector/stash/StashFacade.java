...
public class StashFacade implements ConnectorFacade {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(StashFacade.class);
    ...
    private FileComment toFileComment(String key, pl.touk.sputnik.review.Comment comment, ChangeType changeType) {
        ...
        Anchor anchor = Anchor.builder().path(key).srcPath(key).line(comment.getLine()).lineType(changeType.getNameForStash()).build();
