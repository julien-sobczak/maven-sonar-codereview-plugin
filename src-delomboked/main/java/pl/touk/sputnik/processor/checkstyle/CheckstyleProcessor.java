...
public class CheckstyleProcessor implements ReviewProcessor {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CheckstyleProcessor.class);
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public CheckstyleProcessor(final Configuration configuration) {
