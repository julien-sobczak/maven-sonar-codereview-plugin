...
public class CollectorBugReporter extends AbstractBugReporter {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CollectorBugReporter.class);
    ...
    protected void doReportBug(BugInstance bugInstance) {
        ...
        Violation violation = new Violation(primarySourceLineAnnotation.getClassName(), line, bugInstance.getMessage(), convert(bugInstance.getPriority()));
