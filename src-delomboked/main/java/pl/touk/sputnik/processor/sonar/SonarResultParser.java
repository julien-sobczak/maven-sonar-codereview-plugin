...
class SonarResultParser {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SonarResultParser.class);
    ...
    private static class Component {
        ...
        @java.beans.ConstructorProperties({"path", "moduleKey"})
        @java.lang.SuppressWarnings("all")
        @javax.annotation.Generated("lombok")
        public Component(final String path, final String moduleKey) {
            this.path = path;
    ...
    private Map<String, Component> getComponents(JsonNode componentsNode) {
        ...
        while (it.hasNext()) {
            ...
            components.put(componentNode.path("key").asText(), new Component(pathNode.asText(), moduleNode.isMissingNode() ? null : moduleNode.asText()));
        }
        return components;
    }
    ...
    @java.beans.ConstructorProperties({"resultFile"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public SonarResultParser(final File resultFile) {
