...
public class SonarRunner {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SonarRunner.class);
    ...
    @java.beans.ConstructorProperties({"files", "sonarEmbeddedRunner", "configuration"})
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public SonarRunner(final List<String> files, final EmbeddedRunner sonarEmbeddedRunner, final Configuration configuration) {
        this.files = files;
        this.sonarEmbeddedRunner = sonarEmbeddedRunner;
